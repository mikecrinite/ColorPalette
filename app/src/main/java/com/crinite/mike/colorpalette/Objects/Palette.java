 ...
 * the ColorGrabberService each time a palette is requested
 *
 * @author Michael Crinite
 * @version 06/28/2017
 */
public class Palette {
    //Static ColorGrabberService instance
    private ColorGrabberService cgs = ColorGrabberService.getInstance();
    //Main color of image
    ...
    public ColorGrabberService getCGS() {
        return cgs;
    }
